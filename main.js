...
/*
As a reminder, $(document).ready is used to ensure that the enclosed
code is run after the DOM is finished loading. We can select elements
using the format $(#element-id) or $(.element-class) or $(element)
*/
